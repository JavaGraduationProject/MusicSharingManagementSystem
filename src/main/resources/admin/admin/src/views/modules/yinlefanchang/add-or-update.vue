          ...
          <el-form-item class="input" label="歌曲名称" prop="gequmingcheng">
              <el-input v-model="ruleForm.gequmingcheng" 
                placeholder="歌曲名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原唱" prop="yuanchang">
          <el-input v-model="ruleForm.yuanchang" 
              placeholder="原唱" clearable  :readonly="ro.yuanchang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原唱" prop="yuanchang">
              <el-input v-model="ruleForm.yuanchang" 
                placeholder="原唱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="用户名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
                placeholder="用户名" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="翻唱原因" prop="fanchangyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="翻唱原因"
                  v-model="ruleForm.fanchangyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fanchangyuanyin" label="翻唱原因" prop="fanchangyuanyin">
                    <span>{{ruleForm.fanchangyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gequmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='yuanchang'){
            this.ruleForm.yuanchang = obj[o];
	    this.ro.yuanchang = true;
            continue;
          }
	            	            if(o=='biaoqian'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='fanchangyuanyin'){
            this.ruleForm.fanchangyuanyin = obj[o];
	    this.ro.fanchangyuanyin = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yinlefanchang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yinlefanchangCrossAddOrUpdateFlag = false;
                  this.parent.search();
